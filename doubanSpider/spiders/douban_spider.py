...
class DoubanSpiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for movie in movie_list:
            ...
            # 电影中文名
            douban_item['movie_name_main'] = movie.xpath(
                ".//div[@class='info']/div[@class='hd']/a/span[@class='title'][1]/text()").extract_first()

            # 电影英文名
            movie_name_sub = movie.xpath(
                ".//div[@class='info']/div[@class='hd']/a/span[@class='title'][2]/text()").extract_first()
            if movie_name_sub:
            ...
            # 电影其他名称
            movie_name_other = movie.xpath(
                ".//div[@class='info']/div[@class='hd']/a/span[@class='other']/text()").extract_first()
            if movie_name_other:
        ...
        next_link = response.xpath(
            "//div[@class='article']/div[@class='paginator']/span[@class='next']/link/@href").extract()
        if next_link:
